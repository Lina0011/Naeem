...
public final class STTabbar: UITabBar {
    ...
    @IBInspectable public var centerButtonHeight: CGFloat = 60.0
    @IBInspectable public var padding: CGFloat = 5.0
   
    @IBInspectable public var buttonImage : UIImage = UIImage(systemName: "plus")!
    ...
    private func setupMiddleButton() {
        ...
        centerButton.setImage(largeBoldDoc, for: .normal)
